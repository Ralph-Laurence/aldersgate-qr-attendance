                ...
                <div class="col">
                    <x-flat-worksheet-tabs leading-label="Show" trailing-label="records">
                        <x-slot name="navItems">
                            ...
                            <x-flat-worksheet-tabs-item text="This Week" current/>
                    ...
                    <div class="card mb-4 table-card">
                        <div class="card-header pb-0">
                            ...
                            <div class="d-flex flex-row align-items-center gap-2 mb-3">
                                <h6 class="card-title mb-0">{{ "Junior Highschool Attendance" }}</h6>
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="text-center week-indicator d-flex align-items-center justify-content-center rounded-2 gap-2 my-2 p-2 flat-color-control mx-3">
                                <i class="fa-solid fa-caret-right opacity-75 small"></i>
                                <p class="m-0 small opacity-85">{{ 'Week #' . $weekHint['weekNo'] }}</p>
                                <p class="m-0 small opacity-85">
                                    <i>{{ '( '. $weekHint['weekFrom'] . " --to-- " . $weekHint['weekTo'] . ' )' }}</i>
                                </p>
