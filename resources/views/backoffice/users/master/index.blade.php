            ...
            <div class="row">
                ...
                <div class="col-7 border-start">
                    ...
                    <div class="perms-selector d-flex flex-column gap-1">
                        <x-flat-perms-select as="perm-students"   caption="Manage students"   stretch-width="true" level="3"/>
                        <x-flat-perms-select as="perm-attendance" caption="Manage attendance" stretch-width="true" level="3"/>    
                        <x-flat-perms-select as="perm-users"      caption="Manage users"      stretch-width="true" level="3"/>
                        <x-flat-perms-select as="perm-advanced"   caption="Advanced settings" stretch-width="true" level="3"/>    
                    </div>
                </div>
            </div>
