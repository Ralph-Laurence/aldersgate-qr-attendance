            ...
            <div class="row">
                ...
                <div class="col-7 border-start">
                    ...
                    <div class="perms-selector d-flex flex-column gap-1">
                        <x-flat-perms-select as="perm-students"   caption="Manage students"   stretch-width="true" level="1"/>
                        <x-flat-perms-select as="perm-attendance" caption="Manage attendance" stretch-width="true" level="1"/>    
                        <x-flat-perms-select as="perm-users"      caption="Manage users"      stretch-width="true" level="-1"/>
                ...
                <div class="col">
                    <x-flat-worksheet-tabs leading-label="Show" trailing-label="users">
                        <x-slot name="navItems">
                            <x-flat-worksheet-tabs-item text="Librarians" current />
                    ...
                    <div class="card mb-4 table-card">
                        <div class="card-header pb-0">
                            ...
                            <div class="d-flex flex-row align-items-center gap-2 mb-3">
                                <h6 class="card-title mb-0">{{ "Librarians" }}</h6>
